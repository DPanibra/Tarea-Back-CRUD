...
namespace BikeStore.Models
{
    public partial class BikeStoresContext : IdentityDbContext
    {
        ...
        public virtual DbSet<UsuariosTruchos> UsuariosTruchos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=EDUARDO-PC;initial catalog=BikeStores;integrated security = true");
            }
        }
